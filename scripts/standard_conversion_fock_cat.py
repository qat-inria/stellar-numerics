...
from stellar.cvstates import CatState, FockState
...
if __name__ == "__main__":
    ...
    from_fname = f"fock_1_max_rank_{str(max_rank)}_niter_250"
    ...
    for amp in amp_values:
        ...
        to_fname = f"cat_odd_{amp:.2f}_max_rank_{str(max_rank)}_niter_{niter}"
        to_file = dir / Path(from_fname + ".json")
