...
if __name__ == "__main__":
    ...
    max_rank = 10
    niter = 200
    to_fname = f"fock_2_max_rank_{str(max_rank)}_niter_{niter}"
    ...
    if to_file.exists() and to_file.is_file():
        ...
        pars_GKP = OptimisationParameters(method=Method.gaussian, niter=350)
    ...
    from_fname = f"fock_1_max_rank_{str(max_rank)}_niter_{niter}"
